...
<%@page import="hu.dpc.training.util.Version"%><html>
<%
	/*
...
<title>multimodule-project <%=Version.VALUE%></title>
</head>
...
<body>
	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
        	<div class="container">
				<a class="brand" href="${pageContext.request.contextPath}">multimodule-project</a>
			</div>
		</div>
	</div>
	<div class="container">
